...
struct space
{
    ...
    void add_food(int height,int weight,int quantity){

        foods.push_back(*new food(height,weight,quantity));
...
int main(int argc, char const *argv[])
{
    ...
    map.add_anthill({{10,10}});
    map.add_pheromone(10,20,5);
    map.add_food(5,5,1000);
    map.show_map();
